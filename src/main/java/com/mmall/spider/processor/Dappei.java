...
public class Dappei implements PageProcessor {
    ...
    private final String PAGE_LIST = "https://dappei\\.com/photos\\?category=male&order=id&page=\\d+";
    ...
    public void process(Page page) {
        ...
        if (page.getUrl().regex(PAGE_LIST).match()) {
            ...
            if (CollectionUtils.isNotEmpty(links)) {
                pageIndex++;
                page.addTargetRequest("https://dappei.com/photos?category=male&order=id&page=" + pageIndex);
            }
            /*if (pageIndex == 1) {
    ...
    public static void main(String[] args) {
        Spider.create(new Dappei()).addUrl("https://dappei.com/photos?category=male&order=id&page=1").thread(5).runAsync();
    }
}
